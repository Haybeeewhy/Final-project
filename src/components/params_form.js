                  ...
                  <form method="post" onSubmit={handleFormSubmit}>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-4">
                          <div className="form-group">
                            <label className="mb-1 small">Thickness (above 125mm)</label>
                      ...
                      <div className="mb-3" style={{ borderBottom: "1px dashed var(--bs-border-color)" }}>
                        ...
                        {data.dropData.drop && <>
                          <div className="row mt-2 ms-4">
                            <div className="col-sm-4">
                              <div className="form-group">
                                <label className="mb-1 small">Drop Depth (above 125mm)</label>
                                <input type="number" name="h" min={125} value={data.dropData.h} onChange={handleDropDataChange} className="form-control contact-form"
                        ...
                        {data.headData.head && <>
                          <div className="mt-2 ms-4">
                            <div className="row mb-2">
                              ...
                              <div className="col-sm-4">
                                <div className="form-group">
                                  <label className="mb-1 small">Column Smaller Dimension (mm)</label>
      ...
      <Modal.Body>
        <div id="resultDetails">
          ...
          <div className="mb-3">
            ...
            <div><span className="fw-medium">Ultimate Load:</span> {cleanFloat(slab.ultimateLoad)} kN</div>
          </div>
